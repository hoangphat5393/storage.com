    ...
    return a.widget('ui.sortable', a.ui.mouse, {
        ...
        _mouseStart: function (b, c, d) {
            ...
            if (
                ...
                g.cursor && 'auto' !== g.cursor && ((f = this.document.find('body')), (this.storedCursor = f.css('cursor')), f.css('cursor', g.cursor), (this.storedStylesheet = a('<style>*{ cursor: ' + g.cursor + ' !important; }</style>').appendTo(f))),
                ...
                this.position = this._generatePosition(b),
                    ...
                    this.options.scroll &&
                        (this.scrollParent[0] !== document && 'HTML' !== this.scrollParent[0].tagName
                            ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - b.pageY < g.scrollSensitivity ? (this.scrollParent[0].scrollTop = h = this.scrollParent[0].scrollTop + g.scrollSpeed) : b.pageY - this.overflowOffset.top < g.scrollSensitivity && (this.scrollParent[0].scrollTop = h = this.scrollParent[0].scrollTop - g.scrollSpeed),
                              this.overflowOffset.left + this.scrollParent[0].offsetWidth - b.pageX < g.scrollSensitivity ? (this.scrollParent[0].scrollLeft = h = this.scrollParent[0].scrollLeft + g.scrollSpeed) : b.pageX - this.overflowOffset.left < g.scrollSensitivity && (this.scrollParent[0].scrollLeft = h = this.scrollParent[0].scrollLeft - g.scrollSpeed))
                            : (b.pageY - a(document).scrollTop() < g.scrollSensitivity ? (h = a(document).scrollTop(a(document).scrollTop() - g.scrollSpeed)) : a(window).height() - (b.pageY - a(document).scrollTop()) < g.scrollSensitivity && (h = a(document).scrollTop(a(document).scrollTop() + g.scrollSpeed)),
        ...
        _getParentOffset: function () {
            ...
            return (
                ...
                (this.offsetParent[0] === document.body || (this.offsetParent[0].tagName && 'html' === this.offsetParent[0].tagName.toLowerCase() && a.ui.ie)) &&
                    (b = {
                        top: 0,
                        left: 0,
                    }),
        ...
        a.widget('ui.draggable', a.ui.mouse, {
            ...
            _generatePosition: function (a, b) {
                ...
                return (
                    ...
                    b &&
                        (this.containment &&
                            (this.relativeContainer ? ((d = this.relativeContainer.offset()), (c = [this.containment[0] + d.left, this.containment[1] + d.top, this.containment[2] + d.left, this.containment[3] + d.top])) : (c = this.containment),
        ...
        a.ui.plugin.add('draggable', 'scroll', {
            ...
            drag: function (b, c, d) {
                var e = d.options,
                    ...
                    h = d.document[0];
                g !== h && 'HTML' !== g.tagName
                    ? ((e.axis && 'x' === e.axis) || (d.overflowOffset.top + g.offsetHeight - b.pageY < e.scrollSensitivity ? (g.scrollTop = f = g.scrollTop + e.scrollSpeed) : b.pageY - d.overflowOffset.top < e.scrollSensitivity && (g.scrollTop = f = g.scrollTop - e.scrollSpeed)),
                      (e.axis && 'y' === e.axis) || (d.overflowOffset.left + g.offsetWidth - b.pageX < e.scrollSensitivity ? (g.scrollLeft = f = g.scrollLeft + e.scrollSpeed) : b.pageX - d.overflowOffset.left < e.scrollSensitivity && (g.scrollLeft = f = g.scrollLeft - e.scrollSpeed)))
                    : ((e.axis && 'x' === e.axis) || (b.pageY - a(h).scrollTop() < e.scrollSensitivity ? (f = a(h).scrollTop(a(h).scrollTop() - e.scrollSpeed)) : a(window).height() - (b.pageY - a(h).scrollTop()) < e.scrollSensitivity && (f = a(h).scrollTop(a(h).scrollTop() + e.scrollSpeed))),
...
!(function (a) {
    ...
    postboxes = {
        add_postbox_toggles: function (c, d) {
            var e = this;
            e.init(c, d),
                a('.postbox .hndle, .postbox .handlediv').bind('click.postboxes', function () {
    ...
    (b = wpNavMenu =
        {
            ...
            jQueryExtensions: function () {
                a.fn.extend({
                    ...
                    getItemData: function (a, b) {
                        ...
                        return (
                            b || 'menu-item' != a || (b = this.find('.menu-item-data-db-id').val()),
                            b
                    ...
                    setItemData: function (b, c, d) {
                        return (
                            (c = c || 'menu-item'),
                            d || 'menu-item' != c || (d = a('.menu-item-data-db-id', this).val()),
                            d
                                ? (this.find('input').each(function () {
                                      var e,
                                          f = a(this);
            ...
            refreshAdvancedAccessibility: function () {
                a('.menu-item-settings .field-move a').css('display', 'none'),
                    a('.item-edit').each(function () {
                        ...
                        0 !== p && ((b = l.find('.menus-move-up')), b.prop('title', menus.moveUp).css('display', 'inline')),
                            0 !== p && n && ((b = l.find('.menus-move-top')), b.prop('title', menus.moveToTop).css('display', 'inline')),
                            p + 1 !== t && 0 !== p && ((b = l.find('.menus-move-down')), b.prop('title', menus.moveDown).css('display', 'inline')),
                            0 === p && 0 !== u && ((b = l.find('.menus-move-down')), b.prop('title', menus.moveDown).css('display', 'inline')),
                            n || ((b = l.find('.menus-move-left')), (c = menus.outFrom.replace('%s', r)), b.prop('title', menus.moveOutFrom.replace('%s', r)).html(c).css('display', 'inline')),
                            0 !== p && l.find('.menu-item-data-parent-id').val() !== l.prev().find('.menu-item-data-db-id').val() && ((b = l.find('.menus-move-right')), (c = menus.under.replace('%s', s)), b.prop('title', menus.moveUnder.replace('%s', s)).html(c).css('display', 'inline')),
                            n
                                ? ((d = a('.menu-item-depth-0')), (e = d.index(l) + 1), (t = d.length), (f = menus.menuFocus.replace('%1$s', o).replace('%2$d', e).replace('%3$d', t)))
                                : ((g = l.prevAll('.menu-item-depth-' + parseInt(m - 1, 10)).first()),
                                  (h = g.find('.menu-item-data-db-id').val()),
                                  (i = g.find('.menu-item-title').text()),
                                  (j = a('.menu-item .menu-item-data-parent-id[value="' + h + '"]')),
                                  (e = a(j.parents('.menu-item').get().reverse()).index(l) + 1),
                                  (f = menus.subMenuFocus.replace('%1$s', o).replace('%2$d', e).replace('%3$s', i))),
                            k.prop('title', f).html(f);
                    });
            },
            ...
            initSortables: function () {
                function c(a) {
                    ...
                    (j = a.placeholder.prev()),
                        ...
                        (i = j.length ? ((c = j.menuItemDepth() + 1) > b.options.globalMaxDepth ? b.options.globalMaxDepth : c) : 0);
                }
                ...
                function f(c) {
                    ...
                    if (0 !== c) {
                        ...
                        else if (0 > c && p == t) for (; !a('.menu-item-depth-' + e, b.menuList).length && e > 0; ) e--;
                    ...
                    b.menuList.sortable({
                        ...
                        start: function (e, f) {
                            ...
                            b.isRTL && (f.item[0].style.right = 'auto'),
                                ...
                                d(f, g),
                                (j = f.item.next()[0] == f.placeholder[0] ? f.item.next() : f.item),
                                (k = j.childMenuItems()),
                                o.append(k),
                                (h = o.outerHeight()),
                                (h += h > 0 ? 1 * f.placeholder.css('margin-top').slice(0, -2) : 0),
                        ...
                        stop: function (a, c) {
                            ...
                            (d = o.children().insertAfter(c.item)),
                                ...
                                q > 0 ? e.show() : e.hide(),
                                0 !== h && (c.item.updateDepthClass(q), d.shiftDepthClass(h), f(h)),
                                b.registerChange(),
                                c.item.updateParentMenuItemDBId(),
                                (c.item[0].style.top = 0),
                                b.isRTL && ((c.item[0].style.left = 'auto'), (c.item[0].style.right = 0)),
                                b.refreshKeyboardAccessibility(),
                                b.refreshAdvancedAccessibility();
                        },
                        change: function (a, d) {
            ...
            attachThemeLocationsListeners: function () {
                ...
                (c.action = 'menu-locations-save'),
                    (c['menu-settings-column-nonce'] = a('#menu-settings-column-nonce').val()),
            ...
            attachUnsavedChangesListener: function () {
                a('#menu-management input, #menu-management select, #menu-management, #menu-management textarea, .menu-location-menus select').change(function () {
                    ...
                    0 !== a('#menu-to-edit').length || 0 !== a('.menu-location-menus select').length ? (window.onbeforeunload = function () {}) : a('#menu-settings-column').find('input,select').end().find('a').attr('href', '#').unbind('click');
            },
                ...
                a('#menu-settings-column').bind('click', function (c) {
                    ...
                    if (h.hasClass('nav-tab-link'))
                        (e = h.data('type')),
                            ...
                            a('.tabs-panel-active', f).removeClass('tabs-panel-active').addClass('tabs-panel-inactive'),
                            a('#' + e, f)
                        ...
                        if (h.hasClass('page-numbers'))
                            return (
                                a.post(ajaxurl, c.target.href.replace(/.*\?/, '').replace(/action=([^&]*)/, '') + '&action=menu-get-metabox', function (b) {
            ...
            eventOnClickEditLink: function (b) {
                var c,
                    d,
                    e = /#(.*)$/.exec(b.href);
                return e && e[1] && ((c = a('#' + e[1])), (d = c.parent()), 0 !== d.length)
                    ? (d.hasClass('menu-item-edit-inactive') ? (c.data('menu-item-data') || c.data('menu-item-data', c.getItemData()), c.slideDown('fast'), d.removeClass('menu-item-edit-inactive').addClass('menu-item-edit-active')) : (c.slideUp('fast'), d.removeClass('menu-item-edit-active').addClass('menu-item-edit-inactive')), !1)
                    : void 0;
            },
            ...
            processQuickSearchQueryResponse: function (b, c, d) {
                ...
                return k.length
                    ...
                    : (a('.categorychecklist', d).html('<li><p>' + navMenuL10n.noResultsFound + '</p></li>'), void a('.spinner', d).hide());
            },
