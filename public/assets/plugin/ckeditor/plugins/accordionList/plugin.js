CKEDITOR.plugins.add('accordionList', {
    ...
    init: function (editor) {
        editor.widgets.add('accordionList', {
            ...
            template: '<div class="accordion-list">' + '   <div class="panel-group accordion-list-group accordion-list-items" id="unknown" role="tablist" aria-multiselectable="true"></div>' + '</div>',
            editables: {
                content: {
