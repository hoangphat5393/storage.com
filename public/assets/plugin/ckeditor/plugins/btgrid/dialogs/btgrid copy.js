                ...
                elements: [
                    {
                        ...
                        type: 'select',
                        // required: true,
                        label: lang.selLayout,
                        items: [
                            ['normal', 'container'],
                            ['full-width', 'container-fluid'],
                        ],
                        // validate: validatorNum(lang.LayoutError),
                        setup: function (widget) {
                            this.setValue(widget.data.layoutGrid);
                            console.log(widget.data.layoutGrid);
                        },
                        // When committing (saving) this field, set its value to the widget data.
                        commit: function (widget) {
                            widget.setData('layoutGrid', this.getValue());
                        },
                    },
                    {
                        id: 'colCount',
                        ...
                        setup: function (widget) {
                            ...
                            console.log(widget.data.colCount);
                        },
                        // When committing (saving) this field, set its value to the widget data.
                        commit: function (widget) {
