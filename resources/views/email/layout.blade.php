                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="content-cell" align="center" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:15px 15px 5px">
                                                        <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;line-height:1.5em;margin:0;color:#aeaeae;font-size:12px;text-align:center">&copy;{{ date('Y') }} {{ \App\Libraries\Helpers::get_option_minhnn('name-company') }}. All
                                                            rights reserved.</p>
                                                    </td>
                                                </tr>
                                            </tbody>
